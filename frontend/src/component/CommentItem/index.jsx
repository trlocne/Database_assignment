  ...
  return (
    <div className="flex flex-row pb-[20px]">
      ...
      <div className="w-[85%]">
        ...
        {showReply ? (
          <div
            className="flex flex-row align-center items-center cursor-pointer pt-[5px]"
          ...
          <div className="flex flex-row align-center items-center cursor-pointer pt-[5px]">
            <input
              type="text"
              className="w-[80%] h-[25px] bg-lightGrey outline-none pl-[5px] border-b-[1px] border-b-[#000]"
            />
            <span className="pl-[5px]" onClick={() => setShowReply(true)}>
              Reply
            </span>
          </div>
        )}
  ...
  return (
    <div className="border-t-[1px] border-t-[#EAEAEA] pt-[20px]">
      ...
      {comment.comment_childen.map((commentItem) => (
        <div className="pl-[20px]">{Item({ comment: commentItem })}</div>
      ))}
    </div>
  );
};
