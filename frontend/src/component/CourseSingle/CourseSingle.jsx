          ...
          {openChapterIndex === chapterIndex && (
            <div className="lesson-list px-[15px] pb-[15px] bg-white">
              {chapter.body.map((lesson, lessonIndex) => (
                <div
                  key={lessonIndex}
                  className="lesson flex justify-between items-center ml-[20px] py-[12px]"
                >
        ...
        return (
          <div>
            <div className="py-[20px] px-[30px]">
              ...
              <div className="text-[16px] pt-[10px]">
                ...
                <div className="flex pt-[10px]">
                  ...
                  <Rating
                    ...
                    value={course.header.rating}
                    readOnly
                  />
                </div>
              </div>
              <div className="text-[24px] font-semibold pt-[10px]">
                Requirements
              </div>
              <div className="text-[16px] pt-[10px]">
                {course.header.requirements.reduce(
              ...
              <div className="text-[16px] pt-[10px]">
                {course.header.languages.reduce(
                  (previousValue, currentValue) =>
                    previousValue + ", " + currentValue
                )}
              </div>
          ...
          <div>
            <div className="py-[20px] px-[30px] pt-[30px] pb-[40px]">
              <div className="min-h-[430px]">
                <div className="text-[24px] font-semibold pb-[20px]">
                  Comment
                </div>
            ...
            <div className="py-[20px] px-[30px] bg-white pt-[50px]">
              ...
              <div className="bg-white mt-[15px]">
                <div className="flex flex-row items-center align-center ">
                  <div className="text-[24px] font-semibold pr-[10px]">
                    Rating:
                  </div>
                  <Rating
              ...
              <div className="pt-[20px]">
                <button className="bg-primary w-[127px] h-[40px] rounded-[20px] text-[18px] font-normal text-white hover:bg-[#030391dd]">
                  Comment
                </button>
              </div>
            </div>
          ...
          <div className="w-[1280px] mx-auto py-[50px] flex flex-row">
            <div className="w-[850px]">
              <div>
                ...
                <div className="pt-[20px]">
                  by{" "}
                  <span className="text-[#cacaca]">{course.header.author}</span>
                </div>
                <ul className="flex flex-row py-[20px]">
                  <li className="flex flex-row justify-center align-center pr-[25px]">
                    <img src={clock} />{" "}
                    <div className="pl-[10px]">{course.header.time} Weeks</div>
                  </li>
                  <li className="flex flex-row justify-center align-center pr-[25px]">
                    <img src={students} />{" "}
                    <div className="pl-[10px]">
                      {course.header.students} Students
                    </div>
                  </li>
                  <li className="flex flex-row justify-center align-center pr-[25px]">
                    <img src={lesson_img} />{" "}
                    <div className="pl-[10px]">
                      {course.header.lessons} Lessons
                    </div>
                  </li>
                  {course.header.status == "done" ? (
                    <li>
                      <button className="bg-[#7abe9633] text-[#68B266] font-semibold px-[10px] rounded-[20px]">
                        Done
                      </button>
                    </li>
                  ) : (
                    <li>
                      <button className="bg-[#74addf33] text-[#4957D5] font-semibold px-[10px] rounded-[20px]">
                        Progress
                      </button>
                    </li>
                  )}
            ...
            <div className="relative">
              <div className="border-lightGrey border-[1px] rounded-[20px] absolute top-[20px] w-[410px]">
                <img
                  src={course.header.thumbnail}
                  className="w-[410px] h-[250px] rounded-t-[20px] bg-lightGrey"
                />
                {buy ? (
                  <div className="text-[24px] font-semibold text-black">
                    <div className="flex flex-row justify-center align-center bg-white py-[20px] rounded-b-[20px]">
                      <div className="text-red mx-[30px]">
                        {course.header.price}$
                      </div>
                      <button className="bg-primary w-[127px] h-[40px] rounded-[20px] text-[18px] font-normal text-white mx-[30px] hover:bg-[#030391dd]">
                        Buy Now
                      </button>
                    </div>
                  </div>
            ...
            <div className="w-[850px] text-black px-[10px] text-[16px]">
              <div className="bg-lightGrey min-h-[370px] w-[810px]">
                <nav className="flex flex-row justify-center bg-white align-center w-[810px] font-medium cursor-pointer">
                  <div
                    className={`w-[270px] text-center py-[20px] text-[20px] hover:bg-[#cacaca] border-[2px] border-[#EAEAEA] ${
                      page == "overview"
